#' @title Fit multivariate Unbiased Random Walk model with uncorrelated trait changes and with increasing (exponential accelerating) rate of change through time.
#'
#' @description Function to find maximum likelihood solution to a multivariate Unbiased Random Walk model with uncorrelated trait changes and with increasing (exponential accelerating) rate of change through time.
#'
...
# positive), and data-SD-scaled additive jitter for the ancestral values.
# Result is also clamped to the lower/upper bounds (NA bounds treated as
# -Inf/Inf) so restarts can't violate constraints.
